...
all: clean
	wget --output-document=LibreOffice.AppImage https://libreoffice.soluzioniopen.com/stable/full/LibreOffice-fresh.full-x86_64.AppImage
	chmod +x LibreOffice.AppImage

	./LibreOffice.AppImage --appimage-extract

	mv squashfs-root/opt/libreoffice* squashfs-root/opt/libreoffice
	...
	export ARCH=x86_64 && bin/appimagetool.AppImage squashfs-root LibreOffice.AppImage
	chmod +x LibreOffice.AppImage
